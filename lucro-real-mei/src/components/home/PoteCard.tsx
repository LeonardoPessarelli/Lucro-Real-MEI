  ...
  return (
    <div className="bg-card2 rounded-2xl p-4">
      <div className="flex justify-between items-start mb-3">
        <p className="text-gray-200 text-xs font-semibold uppercase tracking-wider">{icon} {label}</p>
        <span className={`text-lg font-bold font-display ${color}`}>{formatCurrency(value)}</span>
      </div>
