...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-card border-t border-card2 px-6 py-3 flex items-center justify-around z-40">
      ...
      <div className="bg-verde rounded-full w-14 h-14 flex items-center justify-center text-black text-2xl font-bold shadow-[0_0_20px_rgba(74,222,128,0.3)] -mt-6">+</div>
