  ...
  if (!tipoGasto) return (
    <div className="grid grid-cols-2 gap-3">
      <button onClick={() => setTipoGasto('empresa')} className="bg-[#1c1400] border-2 border-ambar rounded-2xl p-4 text-center">
        <p className="text-2xl mb-1">💼</p><p className="text-ambar font-extrabold text-base tracking-wide">Empresa</p>
      ...
      <button onClick={() => setTipoGasto('pessoal')} className="bg-card2 border-2 border-card2 rounded-2xl p-4 text-center">
        <p className="text-2xl mb-1">🏠</p><p className="text-gray-300 font-extrabold text-base tracking-wide">Pessoal</p>
